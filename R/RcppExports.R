...
#'
#' @export
logCPO <- function(CHAIN, data, group, L, alpha_const = FALSE, alpha = -1.0) {
    .Call(`_sBNPi_logCPO`, CHAIN, data, group, L, alpha_const, alpha)
}
...
#'
#' @export
logPML <- function(CHAIN, data, group, L, alpha_const = FALSE, alpha = -1.0) {
    .Call(`_sBNPi_logPML`, CHAIN, data, group, L, alpha_const, alpha)
}
...
log_dmvn_mat_1_obs <- function(x, mu, Sigma) {
    .Call(`_sBNPi_log_dmvn_mat_1_obs`, x, mu, Sigma)
}
